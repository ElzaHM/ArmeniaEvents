        ...
        <div className={styles.footerGrid}>
          ...
          <div>
            ...
            <ul className={styles.footerList}>
              <li>Events</li><li>Categories</li><li>Favorites</li><li>About Us</li><li>Contact</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className={styles.footerList}>
              <li>Programming</li><li>Business</li><li>Music</li><li>Design</li><li>Startup</li><li>AI & Tech</li>
            </ul>
          </div>
