...
export type AnalyticsPrintMode = 'full' | 'summary';

export function printAnalyticsReport(mode: AnalyticsPrintMode): void {
  document.body.setAttribute('data-analytics-print', mode);
